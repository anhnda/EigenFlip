...
Standard sliding-window PPL at seqlen=2048, matching GPTQ/AWQ papers. Use this
to fill Table 6: run once per saved base_encoder/ directory.
"""
...
def main():
    ...
    ppl = eval_ppl(model, tok, args.dataset, args.seqlen, device)
    print(f"{args.dataset} PPL: {ppl:.4f}")
